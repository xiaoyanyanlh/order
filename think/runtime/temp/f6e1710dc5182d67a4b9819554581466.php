<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\wamp64\www\1707\test\WM\think\public/../application/index\view\info\user_orderlist.html";i:1501295075;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
 ...
 <article class="U-article Overflow">
  ...
  <section>
    <table class="Myorder">
     ...
     <?php foreach($userOrder as $value): ?>
     <tr>
      <td class="FontW"><a href="user_order.html"><?php echo $value['orderNum']; ?></a></td>
      <td><?php echo $value['create_time']; ?></td>
      <td><?php echo \think\Session::get('name'); ?></td>
      <td>￥328.00</td>
      <td>
