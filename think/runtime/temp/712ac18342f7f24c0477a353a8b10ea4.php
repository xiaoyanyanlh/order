<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"C:\wamp64\www\1707\test\WM\think\public/../application/index\view\info\user_address.html";i:1501220640;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
  ...
  <section class="Myaddress Overflow">
   ...
   <table>
    ...
    <tr>
     ...
     <td><input type="text" name="" required value="<?php echo $value['recipient']; ?>" class="input_name"></td>
    </tr>
    <tr>
     <td width="30%" class="Font14 FontW Lineheight35" align="right">街道地址：</td>
     <td><input type="text" required size="50" value="<?php echo $value['province'],$value['address']; ?>" class="input_addr"></td>
    </tr>
    <tr>
     <td width="30%" class="Font14 FontW Lineheight35" align="right">邮政编码：</td>
     <td><input type="text" required size="10" pattern="[0-9]{6}" value="100000" class="input_zipcode"></td>
    </tr>
    <tr>
     <td width="30%" class="Font14 FontW Lineheight35" align="right">手机号码：</td>
     <td><input type="text" name="" required pattern="[0-9]{11}" value="<?php echo $value['phone']; ?>" class="input_tel"></td>
    </tr>
    <?php endforeach; ?>
    <tr>
